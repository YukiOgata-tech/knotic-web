...
- パッチ: `supabase/patch-20260224-console-management.sql`, `supabase/patch-20260224-indexing-pipeline.sql`
- パッチ: `supabase/patch-20260224-quotas-and-notifications.sql`
- 接続基盤: `lib/supabase/*`
...
- URLはクロール結果を `source-pages` ではなく `source_pages` + Storageアーティファクトとして保持
