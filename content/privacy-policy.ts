...
export const privacyPolicySections: PrivacyPolicySection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "【操作履歴（監査ログ）】管理コンソール上の操作履歴は、ご契約プランに応じた期間が経過した後、自動的に削除されます。Liteプラン：7日間 / Standard・Proプラン：30日間。プランのダウングレード時は、新しい保持期間を超過した分が次回削除処理時に削除されます。",
      "契約終了後は、チャットログ・RAGデータ・Bot設定等のサービスデータを合理的な期間内に削除または匿名化します。課金履歴は、法令上の保存義務に従い一定期間保持します。",
