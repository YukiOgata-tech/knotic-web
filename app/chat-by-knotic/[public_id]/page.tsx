...
export default async function HostedBotPage({ params, searchParams }: PageProps) {
  ...
  return (
    <div className={embedded ? "h-dvh w-screen bg-transparent p-2" : "min-h-dvh bg-[linear-gradient(180deg,#f8fbff_0%,#ffffff_35%,#fffaf3_100%)] px-3 py-4 dark:bg-[linear-gradient(180deg,#0f172a_0%,#0b1220_45%,#0a0f1a_100%)] sm:px-6 sm:py-8"}>
      {isPreviewMember && (
