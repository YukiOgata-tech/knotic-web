...
- **Starter** — ¥4,900/月。Bot 1体、月間300メッセージ、75MBデータ。Widget埋め込み公開。
- **Lite** — ¥9,800/月。Bot 1体、月間1,000メッセージ、100MBデータ。Widget埋め込み公開。
...
- [料金プラン](${base}/pricing): Starter・Lite・Standard・Proプランの比較
...
- [アカウント・データ管理ガイド](${base}/help/account): ログイン、パスワード変更、Bot削除、テナント脱退・削除
- [プラン・料金ガイド](${base}/help/plans): 無料プランの制限、有料プラン比較、Billing画面、変更・解約方法
- [サービス別Widget設置ガイド](${base}/help/widget-guide): WordPress・Wix・STUDIO・Squarespace・Webflow・Shopify・BASEなどへの設置手順
- [Widget埋め込みガイド](${base}/help/widget): Webサイトへのウィジェット設置手順（HTML・Next.js・React・Vue.js・WordPress）
- [プラン変更と請求の仕様](${base}/help/billing-plan-change): アップグレード、ダウングレード、日割り請求、解約時の扱い
