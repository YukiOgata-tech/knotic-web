    ...
    <>
      ...
      >
            ...
            {[
              {
                ...
                sub: "サイト設置から始める",
                price: "¥4,900",
                points: ["Bot 1体", "月間300メッセージ", "データ75MB", "Widget埋め込み対応"],
                highlight: false,
                accentColor: "#64748b",
              },
              {
        ...
        <div style={{
          ...
          <p style={{ fontSize: "7pt", color: "#d1d4d7", fontWeight: "500" }}>
